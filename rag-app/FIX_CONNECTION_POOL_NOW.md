...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=10&pool_timeout=30
```
...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=15&pool_timeout=0
```
