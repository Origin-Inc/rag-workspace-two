...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-0-us-east-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1
```
...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-0-us-east-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1&connect_timeout=300
```
