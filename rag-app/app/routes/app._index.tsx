    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-theme-bg-primary rounded-lg shadow-sm border border-theme-border-primary">
                ...
                recentPages.map((page) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center text-xs text-theme-text-primary ml-2">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link
          to="/app/pages/new"
          className="p-4 bg-theme-bg-primary rounded-lg shadow-sm border border-theme-border-secondary hover:shadow-md transition-shadow"
        >
