...
export default function SettingsLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[rgba(33,33,33,1)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            {isMainSettingsPage ? (
              <div className="bg-white dark:bg-[rgba(33,33,33,1)] rounded-lg border border-gray-200 dark:border-gray-700 p-6">
