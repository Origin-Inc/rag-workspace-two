...
# Change TO:
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=1
```

#### SUPABASE_SERVICE_ROLE_KEY
1. Go to: https://supabase.com/dashboard
2. Select your project (afqibcfcornmwppxjbyk)
3. Settings → API
