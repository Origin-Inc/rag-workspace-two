...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-0-us-east-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1&pool_timeout=0&connect_timeout=300
```

### 2. Verify DIRECT_URL is Set
```
postgresql://postgres:bonqo4rafgymzizvUp@db.afqibcfcornmwppxjbyk.supabase.co:5432/postgres
```
...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-0-us-east-1.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=1&pool_timeout=0
```

### Option 2: Direct Connection (If IPv4 Add-on Enabled)
```
postgresql://postgres:bonqo4rafgymzizvUp@db.afqibcfcornmwppxjbyk.supabase.co:5432/postgres?schema=public
```
