...
```
postgresql://postgres:bonqo4rafgymzizvUp@db.afqibcfcornmwppxjbyk.supabase.co:5432/postgres?schema=public&connection_limit=5
```

This:
- Bypasses the pooler completely (uses db.afqibcfcornmwppxjbyk instead of pooler.supabase.com)
...
```
postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=1&pool_timeout=0
```
