...
```
DIRECT_URL=postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@db.afqibcfcornmwppxjbyk.supabase.co:5432/postgres
```

Note: This uses the direct connection (db.afqibcfcornmwppxjbyk.supabase.co) not the pooler.

### Verify DATABASE_URL is Correct

Make sure this is still set correctly:
```
DATABASE_URL=postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=1
```
...
```
DATABASE_URL=postgresql://postgres.afqibcfcornmwppxjbyk:bonqo4rafgymzizvUp@aws-1-us-east-2.pooler.supabase.com:5432/postgres?pgbouncer=true&connection_limit=5&pool_timeout=20
```
